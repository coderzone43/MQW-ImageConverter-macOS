...
#endif  // (TARGET_IPHONE_SIMULATOR || TARGET_OS_IPHONE)
{
    ...
    [view addSubview:hud positioned:NSWindowAbove relativeTo:nil];
...
#if (TARGET_IPHONE_SIMULATOR || TARGET_OS_IPHONE)
+ (MB_INSTANCETYPE)showCustomHUDAddedTo:(UIView *)view For:(UIView *)relativeView animated:(BOOL)animated
#else   // !(TARGET_IPHONE_SIMULATOR || TARGET_OS_IPHONE)
+ (MB_INSTANCETYPE)showCustomHUDAddedTo:(NSView *)view For:(NSView *)relativeView animated:(BOOL)animated
#endif  // (TARGET_IPHONE_SIMULATOR || TARGET_OS_IPHONE)
{
    NSAssert(view, @"View must not be nil.");
    MBProgressHUD *hud = [[self alloc] initWithView:view];
    
    [view addSubview:hud positioned:NSWindowAbove relativeTo:relativeView];
